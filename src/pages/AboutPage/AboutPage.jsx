...
export default function AboutPage() {
  ...
  return (
    <section className={styles.container}>
      {
        location.pathname === '/about' && <img src={bgImg} alt="image" className={styles.bgImg}/>
      }
      <nav className={styles.subNav}>
        <NavLink to="/about" className={({isActive}) => `${styles.subNavItem} ${isActive ? styles.active : ''}`} end>
          <p>Деятельность</p>
          <svg
              width="32"
              height="32"
        ...
        <NavLink to="management" className={({isActive}) => `${styles.subNavItem} ${isActive ? styles.active : ''}`}>
          <p>Руководство</p>
          <svg
              width="32"
              height="32"
